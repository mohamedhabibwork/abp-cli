...
const (
	...
	fileTypeGetListInput                 = "get-list-input"
	...
	fileTypeManyToManyJoinEntity         = "many-to-many-join-entity"
	fileTypeManyToManyJoinConfiguration  = "many-to-many-join-configuration"
...
var fileTypeAliases = map[string][]string{
	...
	"get-list-input":                  {fileTypeGetListInput},
	"list-input":                      {fileTypeGetListInput},
	"filter-input":                    {fileTypeGetListInput},
	"dto":                             {fileTypeCreateDto, fileTypeUpdateDto, fileTypeEntityDto, fileTypeGetListInput},
	"dtos":                            {fileTypeCreateDto, fileTypeUpdateDto, fileTypeEntityDto, fileTypeGetListInput},
	...
	"many-to-many-join-entity":        {fileTypeManyToManyJoinEntity},
	"many-to-many-join":               {fileTypeManyToManyJoinEntity, fileTypeManyToManyJoinConfiguration},
	"join-entity":                     {fileTypeManyToManyJoinEntity},
	"many-to-many-join-configuration": {fileTypeManyToManyJoinConfiguration},
	"join-configuration":              {fileTypeManyToManyJoinConfiguration},
